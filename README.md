...
# Сcылка на бота *https://t.me/Privacy_telegram_system_bot*
...
# messenger
## принцип работы:
### сначла разберемся с телеграммом чтобы отправить сообщение бот должен иметь id человека, а если отправляет человек нужно знать его профиль оба варинанта череваты атаками со стороны злоумышленников
